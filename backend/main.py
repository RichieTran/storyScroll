...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://127.0.0.1:3000", "https://story-scroll-774bqtue3-richietrans-projects.vercel.app/"],  # ← replace with your Vercel URL after deploying
